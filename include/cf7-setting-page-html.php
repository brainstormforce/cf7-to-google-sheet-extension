...
<div class="wrap status-check">
	...
	<form  action="options.php" method="post" class="container">
		...
		if ( empty( $get_token['access_token'] ) ) { ?>
			<h2><?php _e( 'Google Spreadsheet Account', 'cf-7-to-spreadsheet') ?> <span class='dashicons dashicons-dismiss not-activate'></span><span class='red-text'><?php _e('Not Connected', 'cf-7-to-spreadsheet')?> </span></h2> </br>
		<?php }
		else { ?>
			<h2><?php _e( 'Google Spreadsheet Account', 'cf-7-to-spreadsheet') ?> <span class='dashicons dashicons-yes activate'></span><span class='green-text'><?php _e('Connected', 'cf-7-to-spreadsheet')?> </span></h2> </br>	
		<?php } ?>
		...
		echo '<a id="google-connect" class="button-primary"  href="'.$google_url.'" target="_blank" > ';
		if( empty( $get_token['access_token'] ) ) {
